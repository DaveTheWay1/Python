...
def say_hi(name):
    print("Hi, " + name)
say_hi("David")
# displays what's within the print statements parenthesis. if it weren't for the 
# print nothing would be displayed. here, nothing is returned as there is no return botton.
